...
app.get('/api/data', async (req, res) => {
    ...
    try {
        ...
        const cumulativeEthGenerated = calculateCumulativeEthGenerated(internalTransactions, supplyChange.length);
...
function calculateCumulativeEthGenerated(transactions, length) {
